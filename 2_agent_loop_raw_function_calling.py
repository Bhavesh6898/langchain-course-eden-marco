...
# Difference 2: Without @tool, we msut Manually define the JSON Schema for each function.
# This is exactly what LangChain's @tool decorator generates automatically
# from the functions type hints and docstring.
...
# direcly as tools (similar to langchains @tool decorator):
